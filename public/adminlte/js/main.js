$(document).ready(function () {
    ...
    //sublevel 1
    var activeSub1 = $(document).find('.active-sub-sub');
    if (activeSub1.length > 0) {
        //activeSub1.addClass('active'); //this
        activeSub1.parent().show(); //<ul>
        activeSub1.parent().addClass('menu-open');//<ul>
        activeSub1.parent().parent().find('.arrow').addClass('open'); //<li>
        activeSub1.parent().parent().addClass('open').addClass('active');//<li>
        activeSub1.parent().parent().show();
        activeSub1.parent().parent().addClass('menu-open');
        activeSub1.parent().parent().parent().find('.arrow').addClass('open');
        activeSub1.parent().parent().parent().addClass('open').addClass('active');
        activeSub1.parent().parent().parent().parent().addClass('active');
    }
