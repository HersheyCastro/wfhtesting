    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Update Accomplishmentsssssss</h3>
        </div>
        <div class="box-body">
          {!! Form::model($targets55, array('id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin'.'.updateadditionalaccomplishmentsforchief', encrypt($targets55->id)))) !!}
           ...
           <!--  <div class="form-group {{ $errors->has('duration') ? 'is-invalid' : '' }}">
            ...
            <table id="t01" class="table table-hover table-responsive table-bordered" width="100%" >
              <tr>
                ...
                <th width="40%">Actual verification</th>
              ...
              @foreach($tasks as $task)
                <tr >
                    ...
                    <td>
                      <input type="number" name="weight[]" required="" value="{{$task->weight}}">
                    </td>
                    <td>
