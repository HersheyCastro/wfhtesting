...
<style type="text/css">
 ...
 <div class="box box-primary ">
        ...
        <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Additional Accomplishmentsssss</h3>
        </div>
        <div class="box-body">
         {!! Form::open(array('route' => 'admin'.'.additionalaccomplishmentsforchief', 'id' => 'form-with-validation')) !!}
