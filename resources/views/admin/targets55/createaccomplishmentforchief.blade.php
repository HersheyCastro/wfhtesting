...
@section('content')
 ...
 <div class="box box-primary ">
        ...
        <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Create Division Accomplishment</h3>
        </div>
        <div class="box-body">
         {!! Form::open(array('route' => 'admin'.'.storedivisionaccomplishments', 'id' => 'form-with-validation')) !!}
