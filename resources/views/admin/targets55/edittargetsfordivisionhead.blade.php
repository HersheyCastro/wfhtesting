    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Validate Target</h3>
        </div>
        <div class="box-body">
          {!! Form::model($targets55, array('id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin'.'.updateverifydivisionhead', encrypt($targets55->id)))) !!}
                ...
                <tr >
                    ...
                    <td>
                        <div class="form-group {{ $errors->has('weight') ? 'is-invalid' : '' }}">
                          <input type="number" name="weight[]" class="form-control" value="{{$task->weight}}" readonly="readonly" /> 
                         </div>
                    </td>
                    <td>
                        <textarea rows="2" cols="50" name="evaluation[]">{{$task->evaluation_divhead}}</textarea>
                    </td>
