...
@section('content')
 ...
 <div class="box box-primary ">
        ...
        <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Add New Success Indicators</h3>
        </div>
        <div class="box-body">
         {!! Form::open(array('route' => 'admin'.'.successindicators55.store', 'id' => 'form-with-validation')) !!}
    ...
    {!! Form::label('success_indicator_name', 'Success Indicator', array('class'=>'control-label')) !!}
        ...
        {!! Form::text('success_indicator_name', old('success_indicator_name'), array('class'=>'form-control','disabled'=> isset($view) ? true : false))  !!}
    ...
    {!! Form::label('strategicobjectives55_id', 'Strategic Objective', array('class'=>'control-label')) !!}
            <span style="font-weight: 700; color: red">*</span>
        {!! Form::select('strategicobjectives55_id', $strategicobjectives55, old('strategicobjectives55_id'), array('class'=>'form-control select2', 'width'=>'100' ,'disabled'=> isset($view) ? true : false)) !!}
