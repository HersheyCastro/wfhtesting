...
@section('content')
    ...
    <div class="box box-danger">
        ...
        <h3 class="box-title"><i class="fa fa-list fa-fw"></i>Users</h3>
        </div>
        <div class="box-body">
            {!! Form::model($users55, array('id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin'.'.users55.update', encrypt($users55->id)))) !!}

            <div class="form-group {{ $errors->has('name') ? 'is-invalid' : '' }}">
    {!! Form::label('name', 'Name', array('class'=>'control-label')) !!}
            <span style="font-weight: 700; color: red">*</span>
        {!! Form::text('name', old('name',$users55->name), array('class'=>'form-control','disabled'=> isset($view) ? true : false))  !!}
        @if ($errors->has('name'))
    ...
    <span style="font-weight: 700; color: red">*</span>
        {!! Form::email('email', old('email',$users55->email), array('class'=>'form-control','disabled'=> isset($view) ? true : false)) !!}
         @if ($errors->has('email'))
                                <span class="invalid-feedback">
...
<div class="form-group {{ $errors->has('password-confirm') ? 'is-invalid' : '' }}">
    ...
    {!! Form::label('roles55_id', 'Role', array('class'=>'control-label')) !!}
        ...
        {!! Form::select('roles55_id', $roles55, old('roles55_id',$users55->roles55_id), array('class'=>'form-control select2', 'width'=>'100' ,'disabled'=> isset($view) ? true : false)) !!}
...
</div><div class="form-group {{ $errors->has('remember_token') ? 'is-invalid' : '' }}">
    {!! Form::label('remember_token', 'Remember Token', array('class'=>'control-label')) !!}
            
        {!! Form::text('remember_token', old('remember_token',$users55->remember_token), array('class'=>'form-control','disabled'=> isset($view) ? true : false))  !!}
