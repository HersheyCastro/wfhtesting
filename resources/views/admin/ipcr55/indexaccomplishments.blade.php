...
@section('content')
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-bar-chart fa-fw"></i>Accomplishments</h3>
                        ...
                        <th class="all">
                            <div class="btn-group tools">
                                 ...
                                 @if(Auth::user()->roles55_id=="4")
                                  <button action="form" type="button" onclick="location.href ='{{ route('admin'.'.newaccomplishments') }}'" class="btn btn-default btn-sm fa fa-plus"></button>
                                @endif
                ...
                <tbody>
                    @foreach ($ipcr55 as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin'.'.accomplishments/', array(encrypt($row->id))) }}">{{ $row->ipcr_name }}</a>
                            </td>
                            <td>
                                @if($row->semester==1)
                                    1st Semester
                            ...
                            <td>
                                ...
                                <div class="btn-group tools">
                                    ...
                                    <button type="button" onclick="location.href ='{{route('admin'.'.accomplishments/', array(encrypt($row->id))) }}'" class="btn btn-default btn-sm fa fa-search"></button>
                                    @endif
