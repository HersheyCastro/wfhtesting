...
@section('title', 'Division Accomplishments')
@section('content')
<!-- index view of IPCR Targets for standard user -->
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-bar-chart fa-fw"></i>Division Accomplishments</h3>
                    ...
                    @foreach ($ipcr55 as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('admin'.'.showaccomplishment_division'.'/', array(encrypt($row->id))) }}">{{ $row->ipcr_name }}</a>
                            </td>
                            <td>
                                @if($row->semester==1)
                                    1st Semester
                            ...
                            <td>
                                ...
                                <div class="btn-group tools">
                                    ...
                                    <button type="button" onclick="location.href ='{{route('admin'.'.showaccomplishment_division'.'/', array(encrypt($row->id))) }}'" class="btn btn-default btn-sm fa fa-search"></button>
                                    @endif
