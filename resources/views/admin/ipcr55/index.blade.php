...
<!-- index view of IPCR Targets for standard user -->
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-bar-chart fa-fw"></i>IPCR Targets (workplan)</h3>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group tools">
                                    ...
                                    <button type="button" onclick="location.href ='{{route('admin'.'.ipcr55.show', array(encrypt($row->id))) }}'" class="btn btn-default btn-sm fa fa-search"></button>
                                    @endif
