...
<style type="text/css">
    ...
    <div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-list fa-fw"></i>IPCR Targets (show for senior)</h3>
        </div>
        <div class="box-body">
          ...
          <table id="t01" class="table table-hover table-responsive table-bordered" width="100%" >
            <tr>
              ...
              <th width="15%">Means of Verification</th>
                      ...
                      <tr>
                        ...
                        @if(!$counter)
                         <td rowspan="{{$tasks->where('targets_id', $target->id)->count() ?? '1'}}">
                              ...
                              <button type="button" onclick="location.href ='{{ route('admin'.'.editsenior',$target->id) }}'" class="btn btn-default btn-sm fa fa-pencil-square-o"></button>
