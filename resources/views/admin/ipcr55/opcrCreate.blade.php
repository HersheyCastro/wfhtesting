...
@section('content')
 ...
 <div class="box box-primary ">
        ...
        <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Create New OPCR</h3>
        </div>
        <div class="box-body">
...
</div><div class="form-group {{ $errors->has('status55_id') ? 'is-invalid' : '' }}">
    ...
    {!! Form::label('active', 'Active', array('class'=>'control-label')) !!}
      ...
      <br>  {!! Form::checkbox('active', 1, old('active'), array('data-toggle'=>'toggle','disabled'=> isset($view) ? true : false)) !!}
        ...
        <div class="box-footer">
            <div class="row">
                <div class="col-md-12">
                  {!! Form::submit( 'Generate OPCR' , array('class' => 'btn btn-primary')) !!}
