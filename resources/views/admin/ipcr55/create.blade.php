...
@section('title', 'IPCR')
@section('content')
<!-- create view of IPCR Targets for standard user -->
 ...
 <div class="box box-primary ">
        ...
        <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Add New IPCR (Standard User)</h3>
        </div>
        <div class="box-body">
...
<input type="hidden" name="status55_id" value="5">
